  ...
  <div className="tl pa3 pa5-ns bg-blue near-white">
    <div className="mw8 center">
      <section className="lh-copy">
        <div className="cf">
          <article className="pv2 w-100 ">
            <h2 className="f2 f1-ns fw6 mb2">
              What I'm ( doing / thinking ) about
            </h2>
            <p className="f5 f4-ns lh-copy mt0">
              I'm currently a Product Engineer at Intercom in Dublin. It's a
              nice balance between engineering and product work, and Intercom is
              at an exciting inflection point. What follows are things I'm
              particularly focused on, both inside and outside of work.
            </p>
          </article>

          <section style={{ display: 'flex', flexWrap: 'wrap' }}>
            <article className="fl pv2 w-100 w-third-l w-50-m ph3">
            ...
            <article className="pv2 fl w-100 w-third-l w-50-m ph3">
              <h2 className="f5 f4-ns fw6 mb0">Generative Artwork</h2>
              <p className="f6 f5-ns lh-copy mt0">
                Computer Generated artwork is an exciting mix between computing
                and creativity in a medium without limits. I'll be publishing
                more around this in the future.
              </p>
            </article>
            <article className="pv2 fl w-100 w-third-l w-50-m ph3">
              ...
              <p className="f6 f5-ns lh-copy mt0">
                ...
                nature. I'm looking into doing more with Bike Packing in the
                near future.
              </p>
            </article>
            <article className="pv2 fl w-100 w-third-l w-50-m ph3">
              ...
              <p className="f6 f5-ns lh-copy mt0">
                ...
                towards helps massively in knowing what you ought to focus on.
                I'm focused on understanding more of the context that surrounds
                my own work and goals.
              </p>
            </article>
            <article className="pv2 fl w-100 w-third-l w-50-m ph3">
