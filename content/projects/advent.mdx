...
[![](/advent/messenger.png)](https://m.me/adventerm)

[![](/advent/telegram.png)](https://telegram.me/cave_adventure_bot)
...
<div className="ph3">
  <dl className="lh-title mv2">
    <dt className="dib b pr1">Advent:</dt>
    <dd className="dib ml0 gray">You are standing at the end of a road before a small brick building.</dd>
  </dl>


<dl className="lh-title mv2">
  <dt className="dib b pr1">Advent:</dt>
  <dd className="dib ml0 gray">Around you is a forest.</dd>
</dl>
...
<dl className="lh-title mv2">
  <dt className="dib b pr1">You:</dt>
  <dd className="dib ml0 gray">building</dd>
</dl>
...
<dl className="lh-title mv2">
  <dt className="dib b pr1">Advent:</dt>
  <dd className="dib ml0 gray">There are some keys on the ground here.</dd>
</dl>

  <dl className="lh-title mv2">
    <dt className="dib b pr1">Advent:</dt>
    <dd className="dib ml0 gray">There is a shiny brass lamp nearby.</dd>
  </dl>
  <dl className="lh-title mv2">
    <dt className="dib b pr1">Advent:</dt>
    <dd className="dib ml0 gray">There is food here.</dd>
  </dl>
  <dl className="lh-title mv2">
    <dt className="dib b pr1">Advent:</dt>
    <dd className="dib ml0 gray">There is a bottle of water here.</dd>
  </dl>
  <dl className="lh-title mv2">
    <dt className="dib b pr1">You:</dt>
    <dd className="dib ml0 gray">get keys</dd>
  </dl>
  <dl className="lh-title mv2">
    <dt className="dib b pr1">Advent:</dt>
    <dd className="dib ml0 gray">Ok</dd>
  </dl>
</div>
